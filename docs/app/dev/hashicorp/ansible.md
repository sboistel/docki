---
title: "Ansible Engine"
description: "Ansible est un outil de gestion de configuration open source, qui permet d'automatiser le déploiement, la configuration et la gestion des systèmes informatiques."
...
WinRM is a management protocol used by Windows to remotely communicate with another server.<br>
...
* [windows_winrm](https://docs.ansible.com/ansible/latest/os_guide/windows_winrm.html#id9)
