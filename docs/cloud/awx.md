...
Main page : https://github.com/ansible/awx/blob/17.0.1/INSTALL.md
...
ÒYou'll begin by setting variables in the inventory file according to the platform you wish to use, and then you'll start the image build and deployment process by running the playbook.
