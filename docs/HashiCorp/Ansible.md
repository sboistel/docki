...
[https://docs.ansible.com/ansible/latest/os\_guide/windows\_winrm.html#id9](https://docs.ansible.com/ansible/latest/os_guide/windows_winrm.html#id9)
...
- name: Playbook 
  ...
  tasks:
    ...
    - name: Task 1
      ansible.builtin.whatever_module:
        # Task details
