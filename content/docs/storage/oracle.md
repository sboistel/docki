...
tags: ["oracle", "database", "multi-model"]
---
...
```oda
odacli describe-network -i $identifiants_réseau
```
...
Connected.
SQL> oda
ALTER USER $USER BY ******** account UNLOCK;
USER altered.
SQL> oda
ALTER USER $USER IDENTIFIED BY ******** account UNLOCK;
USER altered.
```
